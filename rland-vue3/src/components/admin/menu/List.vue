        ...
        <div class="menu-list">
          <section class="menu menu-reg-section border-bottom border-color-1">
            <form class="overflow-hidden">
              ...
              <div class="menu-price"><input class="w-75 w-50-md input ml-0 ml-1-md" type="text" placeholder="가격을 입력하세요">
                원</div>
              ...
              <div class="menu-button-list">
                ...
                <input class="btn btn-fill btn-round rounded-0-md btn-size-1 btn-bd-blue btn-color-blue ml-1"
